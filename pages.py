...
show = '<a href="/manga/{}"><img class="svg back-arrow" src="/static/ico/back_arrow.svg"></a><div class="wrap show-book">{}</div>'
show_book = '<div class="wrap show-book"><a href="{}"><img class="show__img" src="/hentai/{}/{}"></a></div>'
